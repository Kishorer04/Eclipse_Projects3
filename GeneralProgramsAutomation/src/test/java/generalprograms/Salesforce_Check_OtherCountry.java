...
public class Salesforce_Check_OtherCountry 

{
	...
	public static void main(String[] args) throws InterruptedException
	{
		...
		WebElement elee =  driver.findElement(By.xpath("(//input[@autocomplete='country'])[2]"));
		...
		List<WebElement> list = driver.findElements(By.xpath("(//input[@autocomplete='country'])[2]//..//following::div[2]//lightning-base-combobox-item"));
